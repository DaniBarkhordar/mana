...
| Vision Edge Function on the Anthropic SDK with schema-bound output and refusal fallbacks; Gemini selectable; cached, metered per tier, context-enriched; pure logic under `deno test` | Health Connect / HealthKit sync |
