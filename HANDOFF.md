...
| **Design v2 screens.** Today: energy arc, macro bars, meal timeline, body sparkline. Body: trend headline, 30-day chart, metric tile grid with per-tile caveat and citation. Weigh food: readout hero that settles, photo strip, capture flow. Photo scan results sheet. App icon and mark | Sign-in beyond the anonymous session (Phase 4) |
